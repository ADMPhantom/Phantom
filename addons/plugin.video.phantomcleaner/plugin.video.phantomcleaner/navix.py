...
def addJDownloader(base):
    ...
    if not file:
        ...
        dialog.ok("XBMCHUB TEAM", "Navi-X Version Unknown", "Nothing changed!")
        return
    ...
    dialog = xbmcgui.Dialog()
    dialog.ok('XBMCHUB TEAM', 'All Done Thank You', 'Brought To You By XBMCHUB.COM', 'Ensure JDownloader is installed and configured correctly')