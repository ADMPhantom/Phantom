...
def addJDownloader(base):
    ...
    if not file:
        ...
        dialog.ok("Phantom Dev", "Navi-X Version Unknown", "Nothing changed!")
        return
    ...
    dialog = xbmcgui.Dialog()
    dialog.ok('Phantom Dev', 'All Done Thank You', 'Brought To You By Maguinho', 'Ensure JDownloader is installed and configured correctly')