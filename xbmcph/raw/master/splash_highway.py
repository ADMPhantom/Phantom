...
### splash.do_My_Splash('http://phantomtv.googlecode.com/svn/xbmcph/raw/master/logo.png',5); 
### splash.do_My_Splash('http://phantomtv.googlecode.com/svn/xbmcph/raw/master/logo.png',2,True,100,100,600,400); 
...
def do_My_Splash(img='http://phantomtv.googlecode.com/svn/xbmcph/raw/master/logo.png',HowLong=10,resize=False,L=0,T=0,W=1280,H=720): #HowLong in seconds.
...
class MyWindowCountDownWithText(xbmcgui.WindowDialog):
	...
	#def onFocus(self,control): 
	#def onAction(self,action): 
def do_My_TextSplash(msg='',img='http://phantomtv.googlecode.com/svn/xbmcph/raw/master/logo.png',HowLong=10,resize=False,L=0,T=0,W=1280,H=720,TxtColor='0xFFFFFFFF',Font='font14',BorderWidth=10): #HowLong in seconds.
	if resize==False: maxW=1280; maxH=720; W=maxW/2; H=maxH/2; L=maxW/4; T=maxH/4; 
...
def do_My_TextSplash2(msg='',img='http://phantomtv.googlecode.com/svn/xbmcph/raw/master/logo.png',HowLong=10,resize=False,L=0,T=0,W=1280,H=720,TxtColor='0xFFFFFFFF',Font='font14',BorderWidth=10,ImgexitBtn='',colorDiffuse='0xff00ff00'): #HowLong in seconds.
	if resize==False: maxW=1280; maxH=720; W=maxW/2; H=maxH/2; L=maxW/4; T=maxH/4; 
...
def do_My_TextSplash3(msg='',img='http://phantomtv.googlecode.com/svn/xbmcph/raw/master/logo.png',HowLong=10,resize=False,L=0,T=0,W=1280,H=720,TxtColor='0xFFFFFFFF',Font='font14',BorderWidth=10,ImgexitBtn=''): #HowLong in seconds.
